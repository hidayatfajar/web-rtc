              ...
              >
                <div class="text-center">
                  ...
                  <p class="text-slate-400 text-sm mt-2">
                    Shared by {{ store.activeSpeaker?.name }}
                  </p>
                </div>
              </div>
              <ParticipantGrid
            ...
            <div class="absolute bottom-12 left-1/2 -translate-x-1/2 z-30">
              ...
              >
                ...
                <button
                  ...
                  class="group relative w-12 h-12 rounded-full flex items-center justify-center hover:scale-110 active:scale-95 transition-all duration-200"
                  :class="
                  ...
                  "
                  :title="
                    store.isScreenSharing ? 'Stop Sharing' : 'Share Screen'
                  "
                >
                  <transition
                    mode="out-in"
